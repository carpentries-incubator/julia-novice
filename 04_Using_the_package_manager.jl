...
#     ```
#
#     If you prefer to use that method and want to know more, remember how to get [help](02_Getting_started.ipynb).
#
...
#md # ```julia
#md # (@v1.x) pkg> activate projects/trebuchet
#md # ```
...
#md # ```julia
#md # (trebuchet) pkg> add Trebuchet
#md # ```
